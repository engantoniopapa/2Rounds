...
Semaphore *exit_hdisp_inf;// mutex per l'accesso alla varibile exit_hinf
short int exit_hinf;//varibile per segnalare l'uscita agli helper del disptacher inf
Semaphore *exit_hdisp_msg;// mutex per l'accesso alla varibile exit_hmsg
short int exit_hmsg;//varibile per segnalare l'uscita agli helper del disptacher msg
Semaphore *exit_hdisp_boot;// mutex per l'accesso alla varibile exit_hboot
short int exit_hboot;//varibile per segnalare l'uscita agli helper del disptacher boot
